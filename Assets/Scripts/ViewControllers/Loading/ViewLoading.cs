...
{
    public class ViewLoading : BaseViewController
    {

        public override void OnOpen(object data)
        {
            view = Object.Instantiate(Resources.Load<GameObject>("Prefabs/Views/Loading/ViewLoading"));
        ...
        {
            Debug.Log("点击下一页" + no);
            ViewManager.getInstance().CloseView("ViewLoading");
            ViewManager.getInstance().SwitchScene(SceneFSMstateID.Login, null);
        }
    }
}
