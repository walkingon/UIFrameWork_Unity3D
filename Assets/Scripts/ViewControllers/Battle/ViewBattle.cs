...
{
    public class ViewBattle : BaseViewController
    {

        public override void OnOpen(object data)
        {
            view = Object.Instantiate(Resources.Load<GameObject>("Prefabs/Views/Battle/ViewBattle"));
        ...
        {
            Debug.Log("点击下一页" + no);
            ViewManager.getInstance().CloseView("ViewBattle");
